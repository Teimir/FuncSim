...
#ifndef LLVM_LIB_TARGET_E32C_E32CCONDCODE_H
#define LLVM_LIB_TARGET_E32C_E32CCONDCODE_H
...
inline static StringRef e32cCondCodeToString(LPCC::CondCode CC) {
  switch (CC) {
  case LPCC::ICC_T:
    return "t"; // true
  case LPCC::ICC_F:
...
inline static CondCode suffixToE32CCondCode(StringRef S) {
...
#endif // LLVM_LIB_TARGET_LANAI_E32CCONDCODE_H
