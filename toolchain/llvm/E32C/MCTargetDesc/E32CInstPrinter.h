//= E32CInstPrinter.h - Convert E32C MCInst to asm syntax -------*- C++ -*--//
//
...
//===----------------------------------------------------------------------===//
//
// This class prints a E32C MCInst to a .s file.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_E32C_MCTARGETDESC_E32CINSTPRINTER_H
#define LLVM_LIB_TARGET_E32C_MCTARGETDESC_E32CINSTPRINTER_H
...
class E32CInstPrinter : public MCInstPrinter {
public:
  E32CInstPrinter(const MCAsmInfo &MAI, const MCInstrInfo &MII,
...
#endif // LLVM_LIB_TARGET_E32C_MCTARGETDESC_E32CINSTPRINTER_H
