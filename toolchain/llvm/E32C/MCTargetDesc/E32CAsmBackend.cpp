//===-- E32CAsmBackend.cpp - E32C Assembler Backend ---------------------===//
//
...
namespace {
class E32CAsmBackend : public MCAsmBackend {
  Triple::OSType OSType;

public:
  E32CAsmBackend(const Target &T, Triple::OSType OST)
  ...
  unsigned getNumFixupKinds() const override {
    return E32C::NumTargetFixupKinds;
  }
...
bool E32CAsmBackend::writeNopData(raw_ostream &OS, uint64_t Count,
...
void E32CAsmBackend::applyFixup(const MCAssembler &Asm, const MCFixup &Fixup,
...
std::unique_ptr<MCObjectTargetWriter>
E32CAsmBackend::createObjectTargetWriter() const {
  return createE32CELFObjectWriter(MCELFObjectTargetWriter::getOSABI(OSType));
}

const MCFixupKindInfo &
E32CAsmBackend::getFixupKindInfo(MCFixupKind Kind) const {
  static const MCFixupKindInfo Infos[E32C::NumTargetFixupKinds] = {
      // This table *must* be in same the order of fixup_* kinds in
      // E32CFixupKinds.h.
      // Note: The number of bits indicated here are assumed to be contiguous.
      //   This does not hold true for E32C_21 and E32C_21_F which are applied
      ...
      {"FIXUP_E32C_NONE", 0, 32, 0},
      {"FIXUP_E32C_21", 16, 16 /*21*/, 0},
      {"FIXUP_E32C_21_F", 16, 16 /*21*/, 0},
      {"FIXUP_E32C_25", 7, 25, 0},
      {"FIXUP_E32C_32", 0, 32, 0},
      {"FIXUP_E32C_HI16", 16, 16, 0},
      {"FIXUP_E32C_LO16", 16, 16, 0}};
...
MCAsmBackend *llvm::createE32CAsmBackend(const Target &T,
  ...
  return new E32CAsmBackend(T, TT.getOS());
}
