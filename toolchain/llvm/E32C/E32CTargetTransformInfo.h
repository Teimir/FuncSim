//===-- E32CTargetTransformInfo.h - E32C specific TTI ---------*- C++ -*-===//
//
...
// E32C target machine. It uses the target's detailed information to
// provide more precise answers to certain TTI queries, while letting the
// target independent and default TTI implementations handle the rest.
//
//===----------------------------------------------------------------------===//

#ifndef LLVM_LIB_TARGET_E32C_E32CTARGETTRANSFORMINFO_H
#define LLVM_LIB_TARGET_E32C_E32CTARGETTRANSFORMINFO_H
...
namespace llvm {
class E32CTTIImpl : public BasicTTIImplBase<E32CTTIImpl> {
  typedef BasicTTIImplBase<E32CTTIImpl> BaseT;
  typedef TargetTransformInfo TTI;
  friend BaseT;

  const E32CSubtarget *ST;
  const E32CTargetLowering *TLI;

  const E32CSubtarget *getST() const { return ST; }
  const E32CTargetLowering *getTLI() const { return TLI; }

public:
  explicit E32CTTIImpl(const E32CTargetMachine *TM, const Function &F)
...
#endif // LLVM_LIB_TARGET_E32C_E32CTARGETTRANSFORMINFO_H
