//===-- E32CAluCode.h - ALU operator encoding ----------------------------===//
//
...
#ifndef LLVM_LIB_TARGET_E32C_E32CALUCODE_H
#define LLVM_LIB_TARGET_E32C_E32CALUCODE_H
...
const int E32C_PRE_OP = 0x40;
const int E32C_POST_OP = 0x80;

inline static unsigned encodeE32CAluCode(unsigned AluOp) {
...
inline static const char *e32cAluCodeToString(unsigned AluOp) {
...
inline static AluCode stringToE32CAluCode(StringRef S) {
...
#endif // LLVM_LIB_TARGET_LANAI_E32CALUCODE_H
